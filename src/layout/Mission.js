            ...
            <Grid container>
                <Grid item xs={12} md={6} className={classes.missionParagraph}>
                    ...
                    <p style={{fontSize: !fullWidth && !fontTransform ? "18px" : "16px"}}>
                        ...
                        development with focus on test automation for securities data distribution,
                        trading systems, risk management, market surveillance and post-trade infrastructures.
                        <br/><br/>
                        We use bespoke tools and methods for every challenge and do whatever it takes to help our clients.</p>
                        <br/>
                </Grid>
                <Grid item xs={12} md={6} className={classes.missionImage}>
                    <img className={classes.image} src="https://bit.ly/3zJZxqK" alt=""/>
                </Grid>
            </Grid>
        </Box>
    );
